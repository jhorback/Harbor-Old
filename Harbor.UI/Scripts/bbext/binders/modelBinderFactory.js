/*
 * modelBinderFactory
 *     modelBinderFactory.create(model, el);
 *
 ...
 *     
 */
var modelBinderFactory = function ($, _, config) {

	var modelBinderFactory, _private, $, _, config;
...
context.module("bbext").service("modelBinderFactory", ["$", "_", "modelBinderConfig", modelBinderFactory]);